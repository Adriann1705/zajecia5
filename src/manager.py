...
class Manager:
    ...
    def get_apartment_costs(self, apartment_key, year=None, month= None):
        ...
        cost = sum(bill.amount_pln for bill in self.bills
                   if bill.apartment == apartment_key and (bill.settlement_year == year or year == None) and (bill.settlement_month == month or month == None))
        return float(cost)
    ...
    def get_tenant_settlement(self, apartment_settlement: ApartmentSettlement):
